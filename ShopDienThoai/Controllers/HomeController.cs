...
namespace ShopDienThoai.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, DienthoaiDBContext context)
        {
            _logger = logger;
            _context = context;
        }
        ...
        public IActionResult Index()
        {
            ...
            var quangcao = _context.QuangCaos.AsNoTracking().FirstOrDefault(x => x.Active == true);
            var tintuc = _context.TinDangs.AsNoTracking().Where(x => x.Published == true && x.IsNewfeed == true)
